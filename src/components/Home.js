...
//   <div className= "languages-container">
//     <ul className='languages'>
//       <li><a href= {props.link} className='language'>{props.title}</a></li>
//     </ul>
//   </div>
//   )
// }
...
// const listlanguages = languages.map(link, language =>
//   <li><a href= {link}>{language}</a></li>
// )
// return <ul>{listlanguages}</ul>
// }
